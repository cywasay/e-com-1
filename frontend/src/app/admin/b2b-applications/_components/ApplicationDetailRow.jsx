        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-y-4 text-xs">
              <div><p className="text-gray-400 mb-1">Company Name</p><p className="font-bold text-foreground">{app.company_name}</p></div>
              <div><p className="text-gray-400 mb-1">Business Type</p><p className="font-bold text-foreground">{app.business_type}</p></div>
              <div><p className="text-gray-400 mb-1">Tax ID / TRN</p><p className="font-bold text-foreground">{app.tax_id || "Not Provided"}</p></div>
              <div><p className="text-gray-400 mb-1">Volume</p><p className="font-bold text-foreground">{app.est_order_volume}</p></div>
            </div>
            {app.admin_notes && (
